...
void setSliderValue(SScriptCallBack *p, setSliderValue_out *out, int handle, int id, int value);
...
void setEditValue(SScriptCallBack *p, setEditValue_out *out, int handle, int id, std::string value);
...
void setCheckboxValue(SScriptCallBack *p, setCheckboxValue_out *out, int handle, int id, int value);
...
void setRadiobuttonValue(SScriptCallBack *p, setRadiobuttonValue_out *out, int handle, int id, int value);
...
void setLabelText(SScriptCallBack *p, setLabelText_out *out, int handle, int id, std::string text);
...
void insertComboboxItem(SScriptCallBack *p, insertComboboxItem_out *out, int handle, int id, int index, std::string text);
...
void removeComboboxItem(SScriptCallBack *p, removeComboboxItem_out *out, int handle, int id, int index);
