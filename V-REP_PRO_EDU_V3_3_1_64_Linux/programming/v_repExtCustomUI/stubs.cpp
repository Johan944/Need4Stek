...
bool registerScriptStuff()
{
    try
    {
        ...
        simRegisterScriptCallbackFunctionE("simExtCustomUI_setSliderValue@CustomUI", "simExtCustomUI_setSliderValue(number handle,number id,number value)", setSliderValue_callback);
        ...
        simRegisterScriptCallbackFunctionE("simExtCustomUI_setEditValue@CustomUI", "simExtCustomUI_setEditValue(number handle,number id,string value)", setEditValue_callback);
        ...
        simRegisterScriptCallbackFunctionE("simExtCustomUI_setCheckboxValue@CustomUI", "simExtCustomUI_setCheckboxValue(number handle,number id,number value)", setCheckboxValue_callback);
        ...
        simRegisterScriptCallbackFunctionE("simExtCustomUI_setRadiobuttonValue@CustomUI", "simExtCustomUI_setRadiobuttonValue(number handle,number id,number value)", setRadiobuttonValue_callback);
        ...
        simRegisterScriptCallbackFunctionE("simExtCustomUI_setLabelText@CustomUI", "simExtCustomUI_setLabelText(number handle,number id,string text)", setLabelText_callback);
        simRegisterScriptCallbackFunctionE("simExtCustomUI_insertComboboxItem@CustomUI", "simExtCustomUI_insertComboboxItem(number handle,number id,number index,string text)", insertComboboxItem_callback);
        simRegisterScriptCallbackFunctionE("simExtCustomUI_removeComboboxItem@CustomUI", "simExtCustomUI_removeComboboxItem(number handle,number id,number index)", removeComboboxItem_callback);
...
void setSliderValue(SScriptCallBack *p, int handle, int id, int value)
{
...
void setSliderValue(SScriptCallBack *p, setSliderValue_out *out_args, int handle, int id, int value)
{
    setSliderValue_in in_args;
    in_args.handle = handle;
    in_args.id = id;
...
void setEditValue(SScriptCallBack *p, int handle, int id, std::string value)
{
...
void setEditValue(SScriptCallBack *p, setEditValue_out *out_args, int handle, int id, std::string value)
{
    setEditValue_in in_args;
    in_args.handle = handle;
    in_args.id = id;
...
void setCheckboxValue(SScriptCallBack *p, int handle, int id, int value)
{
...
void setCheckboxValue(SScriptCallBack *p, setCheckboxValue_out *out_args, int handle, int id, int value)
{
    setCheckboxValue_in in_args;
    in_args.handle = handle;
    in_args.id = id;
...
void setRadiobuttonValue(SScriptCallBack *p, int handle, int id, int value)
{
...
void setRadiobuttonValue(SScriptCallBack *p, setRadiobuttonValue_out *out_args, int handle, int id, int value)
{
    setRadiobuttonValue_in in_args;
    in_args.handle = handle;
    in_args.id = id;
...
void setLabelText(SScriptCallBack *p, int handle, int id, std::string text)
{
...
void setLabelText(SScriptCallBack *p, setLabelText_out *out_args, int handle, int id, std::string text)
{
    setLabelText_in in_args;
    in_args.handle = handle;
    in_args.id = id;
...
void insertComboboxItem(SScriptCallBack *p, int handle, int id, int index, std::string text)
{
...
void insertComboboxItem(SScriptCallBack *p, insertComboboxItem_out *out_args, int handle, int id, int index, std::string text)
{
    insertComboboxItem_in in_args;
    in_args.handle = handle;
    in_args.id = id;
...
void removeComboboxItem(SScriptCallBack *p, int handle, int id, int index)
{
...
void removeComboboxItem(SScriptCallBack *p, removeComboboxItem_out *out_args, int handle, int id, int index)
{
    removeComboboxItem_in in_args;
    in_args.handle = handle;
    in_args.id = id;
